...
function MiniAvatar({ p, size = 20 }) {
  if (p.avatar_url) return <img src={urlImagem(urlAsset(p.avatar_url), 128, { quadrado: true })} alt="" width={size} height={size} decoding="async" loading="lazy" style={{ width: size, height: size, borderRadius: '50%', objectFit: 'cover', objectPosition: 'top' }} />;
